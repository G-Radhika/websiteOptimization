...
// variable pizzasDiv  gets elementID of randomPizzas
...
function updatePositions() {
  ...
  //Made the change you suggested, it does make a lot of sense
  var phase;
  for (; i < pizzanum; i++) {
...
document.addEventListener('DOMContentLoaded', function() {
  var i = 0
  var s = 256;
  var elem; //Should be declared outside the loop to prevent it from created everytime. should rememebr this.
